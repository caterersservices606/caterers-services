...
#         # If no restrictions defined, deny access
#         if method not in required_roles:
#             print('method not in required_roles')
#             return False
#         print(request.user.role , required_roles[method],'request.user.role in required_roles[method]')
#         return request.user.role in required_roles[method]
